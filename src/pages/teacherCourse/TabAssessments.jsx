...
export default function TabAssessments({ courseId, course, onCourseUpdated }) {
  ...
  const headerHint =
    courseType === "lab"
      ...
      : courseType === "hybrid"
        ? `${getCtPolicyLabel(getDefaultCtPolicy(course))}, Theory Mid (20), Lab Mid (10), Theory Final (30), Lab Final (10), Assignment/Presentation (one combined Assignment category), Attendance (5).`
        : `${getCtPolicyLabel(getDefaultCtPolicy(course))}, Mid (30), Final (40), Assignment/Presentation (10), Attendance (5).`;
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-2">
              {courseType !== "lab" && (
                <button
                  ...
                  className="inline-flex h-9 items-center gap-2 rounded-xl border border-indigo-200 bg-indigo-50 px-3 text-xs font-bold text-indigo-700 transition hover:border-indigo-300 hover:bg-indigo-100 dark:border-indigo-500/25 dark:bg-indigo-500/10 dark:text-indigo-300 dark:hover:bg-indigo-500/20"
                >
      ...
      <CourseAssessmentPolicyModal
        ...
        courseId={courseId}
        course={course}
        assessments={markEntryAssessments}
